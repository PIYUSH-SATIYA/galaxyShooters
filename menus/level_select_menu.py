...
class LevelSelectMenu(BaseMenu):
    ...
    def draw(self, surface):
        ...
        # Draw level options with descriptions
        start_y = 250
        option_spacing = 70
        ...
        for i, (level_name, description) in enumerate(zip(self.level_names, self.level_descriptions)):
            ...
            # Draw description (except for "Back to Main Menu")
            if i < len(self.level_descriptions) - 1:  # Skip description for "Back" option
    ...
    def execute_option(self):
        ...
        if self.selected_option < 5:  # Level 1-5
